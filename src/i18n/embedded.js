...
export const fr = {
  ...
  "pwa": {
    ...
    "installPrompt": "Installer MANARA sur cet appareil",
  ...
  "dialogs": {
    ...
    "close": "Fermer",
    "welcomeToOnuf": "Bienvenue dans MANARA !",
...
export const en = {
  ...
  "pwa": {
    ...
    "installPrompt": "Install MANARA on this device",
  ...
  "dialogs": {
    ...
    "retryCount": "Retry",
    "close": "Close",
    "welcomeToOnuf": "Welcome to MANARA!",
...
export const ar = {
  ...
  "pwa": {
    ...
    "installPrompt": "تثبيت MANARA على هذا الجهاز",
  ...
  "dialogs": {
    ...
    "close": "إغلاق",
    "welcomeToOnuf": "مرحباً بك في MANARA!",
